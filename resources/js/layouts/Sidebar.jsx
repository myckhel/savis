        ...
        <div className="deznav">
            {doc && (
                ...
                <Link href="/plugins/nestable">Nestedable</Link>
                                ...
                                <li>
                                    <Link href="/plugins/noui-slider">
                                        Noui Slider
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/plugins/sweetalert">
                                        Sweet Alert
                                    </Link>
                                </li>
                                <li>
                ...
                <li>
                  <Link href="/pages/register">Register</Link>
                                ...
                                <li>
                                    ...
                                    <ul aria-expanded="false">
                                        <li>
                                            <Link href="/pages/error/400">
                                                Error 400
                                            </Link>
                                        </li>
                                        <li>
                                            <Link href="/pages/error/403">
                                                Error 403
                                            </Link>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <Link href="/pages/error/500">
                                                Error 500
                                            </Link>
                                        </li>
                                        <li>
                                            <Link href="/pages/error/503">
                                                Error 503
                                            </Link>
                                        </li>
                                    </ul>
